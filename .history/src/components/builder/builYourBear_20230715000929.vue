  ...
  <div class="flex items-center justify-center">
    ...
    <div class="traitsPickerRight grid grid-flow-row gap-4 row">
      ...
      <div class="grid grid-cols-3 items-center justify-center text-center">
        <div class="arrow arrow--left col-span-1 w-1/5" @click="prevColor('background')">
          <span>Prev</span>
        </div>
        <span class="cursor-pointer hover:text-red-500 col-span-1 w-3/5" @click="removeTrait('background')"
              @mouseenter="isHovered.background = true" @mouseleave="isHovered.background = false">
          {{ isHovered.background ? 'Remove' : 'Background' }}
        </span>
        <div class="arrow arrow--right col-span-1 w-1/5" @click="nextColor('background')">
          <span>Next</span>
        </div>
      </div>
