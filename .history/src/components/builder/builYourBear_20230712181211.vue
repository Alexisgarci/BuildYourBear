<template>
    <div class="">
      ...
      <div class="flex items center justify-center">
        ...
        <div class=" w-full h-full bg-blue-500 " id="backgroundBuilderCanvas"></div>  
        <div id="speciesBuilderCanvas"></div>  
        <div id="faceBuilderCanvas"></div>  
        <div id="clothesBuilderCanvas"></div>  
        <div id="facialhairBuilderCanvas"></div>  
        <div id="facewearBuilderCanvas" ></div>  
        <div id="headwearBuilderCanvas" ></div>  
        <div id="cigarpipeBuilderCanvas"></div>  
      </div>
      </div>
      <div class="flex items center justify-center">
        <div>
