    ...
    <div class="">
      ...
      <div class="flex items center justify-center">
        <div class=" w-80 h-80" id="bearBuilder">
          <div  class=" w-full h-full" id="backgroundBuilderCanvas" data-trait="background"></div>  
...
<div class="mt-3">
  <div id="backgroundsBuilderTab" role="tabpanel" aria-labelledby="backgroundsBuilderSelector">
    <div class="content center justify-center">
      <div class="carousel h-24 center justify-center">
  ...
  <div id="speciesBuilderTab" class="hidden" role="tabpanel" aria-labelledby="speciesBuilderSelector">
    <div class="content center justify-center">
      <div class="carousel2 h-24 center justify-center">
