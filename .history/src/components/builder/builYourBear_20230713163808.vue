<template>
    <div class="">
      ...
      <div class="flex items center justify-center">
        <div class=" w-80 h-80" id="bearBuilder">
          <div  class="relative left-0 w-full h-full" id="backgroundBuilderCanvas" data-trait="background"></div>  
          <div style="z-index:2;" class="absolute left-0  w-full h-full" id="speciesBuilderCanvas"></div>  
          <div class=" relative left-0 w-full h-full" id="faceBuilderCanvas"></div>  
          <div class="relative left-0  w-full h-full" id="clothesBuilderCanvas"></div>  
          <div class=" relative left-0 w-full h-full" id="facialhairBuilderCanvas"></div>  
          <div class=" relative left-0 w-full h-full" id="facewearBuilderCanvas" ></div>  
          <div class=" relative left-0 w-full h-full" id="headwearBuilderCanvas" ></div>  
          <div class=" relative left-0 w-full h-full" id="cigarpipeBuilderCanvas"></div>  
        </div>
      </div>
      <div class="flex items center justify-center">
        <div>
  ...
  <div id="backgroundsBuilderTab" role="tabpanel" aria-labelledby="backgroundsBuilderSelector">
    <div class="content center justify-center">
      <div class="carousel center justify-center">
              <img src="../../assets/images/traits/background/01.png" class="product-image" data-trait="background" data-src="01.png" alt="">
              <img src="../../assets/images/traits/background/02.png" class="product-image" data-trait="background" data-src="02.png" alt="">
              <img src="../../assets/images/traits/background/03.png" class="product-image" data-trait="background" data-src="03.png" alt="">
              <img src="../../assets/images/traits/background/04.png" class="product-image" data-trait="background" data-src="04.png" alt="">
              <img src="../../assets/images/traits/background/05.png" class="product-image" data-trait="background" data-src="05.png" alt="">
            </div>
    </div>
  </div>
