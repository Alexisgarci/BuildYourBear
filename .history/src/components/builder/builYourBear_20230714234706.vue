  ...
  <div class="flex items-center justify-center">
    ...
    <div class="traitsPickerRight grid grid-flow-row gap-4 row">
      <div class="grid grid-cols-3 items-center justify-center text-center">
        ...
        <div class="text-center justify-center absolute top-[-30px]  p-2 text-sm text-red-500 rounded mt-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible">
          remove
        </div>
        </div>
