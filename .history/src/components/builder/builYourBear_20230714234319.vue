<template>
  <div class="flex items-center justify-center">
    ...
    <!-- TRAITS PICKER RIGHT -->
    <div class="traitsPickerRight grid-flow-row gap-4 row">
      <div class="grid grid-cols-3 items-center justify-center text-center">
        ...
        <div class="absolute top-1 left-0 bg-red-200 p-2 text-sm text-gray-800 rounded mt-2 opacity-0 invisible group-hover:opacity-100 group-hover:visible">
          Message
        </div>
        </div>
