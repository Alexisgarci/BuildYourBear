<template>
  ...
  <div class="w-80 h-80 relative" id="bearBuilder">
    <div style="background-image: url(src/assets/images/traits/species/04.png)" class="absolute left-0 w-full h-full z-10" id="backgroundBuilderCanvas" data-trait="background"></div>  
