<template>
    <svg xmlns="http://www.w3.org/2000/svg" width="10px" height="10px" style="shape-rendering:geometricPrecision;text-rendering:geometricPrecision;image-rendering:optimizeQuality;fill-rule:evenodd;clip-rule:evenodd">
