<template>
  <div class="flex items-center justify-center">
    ...
    <div class="traitsPickerRight">
      ...
      <div class="grid grid-cols-3 items-center justify-center text-center">
        <div class="arrow arrow--left" @click="prevColor('hair')">
          <span>Prev</span>
        </div>
        <span class="">Facial Hair</span>
        <div class="arrow arrow--right" @click="nextColor('hair')">
          <span>Next</span>
        </div>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    nextColor(trait) {
      ...
      console.log(this.traits[trait][this.currentIndex[trait]]);
    }
