<template>
  ...
  <nav class="flex space-x-2" aria-label="Tabs" role="tablist">
    <button type="button" class="hs-tab-active:font-semibold hs-tab-active:border-blue-600 hs-tab-active:text-blue-600 py-4 px-1 inline-flex items-center gap-2 border-b-[3px] border-transparent text-sm whitespace-nowrap text-gray-500 hover:text-blue-600 active" id="tabs-with-icons-item-1" data-hs-tab="#tabs-with-icons-1" aria-controls="tabs-with-icons-1" role="tab">
      <svg class="hs-tab-active:text-blue-600 hs-tab-active:text-blue-600 w-3.5 h-3.5 text-gray-400 text-gray-600" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
<div class="mt-3">
  <div id="tabs-with-icons-1" role="tabpanel" aria-labelledby="tabs-with-icons-item-1">
    <p class="text-gray-500 text-gray-400">
      This is the <em class="font-semibold text-gray-800 text-gray-200">first</em> item's tab body.
    </p>
  </div>
  <div id="tabs-with-icons-2" class="hidden" role="tabpanel" aria-labelledby="tabs-with-icons-item-2">
    <p class="text-gray-500 text-gray-400">
      This is the <em class="font-semibold text-gray-800 text-gray-200">second</em> item's tab body.
    </p>
  </div>
  <div id="tabs-with-icons-3" class="hidden" role="tabpanel" aria-labelledby="tabs-with-icons-item-3">
    <p class="text-gray-500 text-gray-400">
      This is the <em class="font-semibold text-gray-800 text-gray-200">third</em> item's tab body.
    </p>
  </div>
</div>
      ...
      <div class="traitsContainer">
        ...
        <div class="allTraits">
          <!-- Cigar / Pipe -->
          <button class="collapsible">Cigar / Pipe</button>
          <div class="content">
            <div class="carousel">
              <img src="../../assets/images/788.png" class="product-image" alt="Succulent in planter">
              <img src="../../assets/images/43.png" class="product-image" alt="Succulent in planter">
              <img src="../../assets/images/1692.png" class="product-image" alt="Succulent in planter">
              <img src="../../assets/images/2804.png" class="product-image" alt="Succulent in planter">
              <img src="../../assets/images/6481.png" class="product-image" alt="Succulent in planter">
              <img src="../../assets/images/6558.png" class="product-image" alt="Succulent in planter">

            </div>
          </div>
          <!-- Clothes -->
          <button class="collapsible">Clothes</button>
          <div class="content">
          ...
          <!-- Face -->
          <button class="collapsible">Face</button>
          <div class="content">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et
              dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex
              ea commodo consequat.</p>
          ...
          <!-- Facewear -->
          <button class="collapsible">Facewear</button>
          <div class="content">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et
              dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex
              ea commodo consequat.</p>
          ...
          <!-- Facial Hair -->
          <button class="collapsible">Facial Hair</button>
          <div class="content">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et
              dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex
              ea commodo consequat.</p>
          ...
          <!-- Headwear -->
          <button class="collapsible">Headwear</button>
          <div class="content">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et
              dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex
              ea commodo consequat.</p>
      ...
      <div class="bearContainer">
          <div id="bearCigarPipe"></div>
          <div id="bearClothes"></div>
          <div id="bearFace"></div>
          <div id="bearFacewear"></div>
          <div id="bearFacialhair"></div>
          <div id="bearHeadwear"></div>
          <div id="bearSpecies"></div>
      </div>
