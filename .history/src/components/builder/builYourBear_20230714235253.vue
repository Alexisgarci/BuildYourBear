<template>
  <div class="flex items-center justify-center">
    ...
    <div class="traitsPickerRight grid grid-flow-row gap-4 row">
      ...
      <div class="grid grid-cols-3 items-center justify-center text-center">
    <div class="arrow arrow--left" @click="prevColor(trait)">
      <span>Prev</span>
    </div>
    <span class="cursor-pointer hover:text-red-500" @click="removeTrait(trait)"
          @mouseenter="isHovered = true" @mouseleave="isHovered = false">
      {{ isHovered ? 'Remove' : 'Clothes' }}
    </span>
    <div class="arrow arrow--right" @click="nextColor(trait)">
      <span>Next</span>
    </div>
  </div>
