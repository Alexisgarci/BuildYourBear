<template>
  <div class="flex items-center justify-center">
    ...
    <div class="traitsPickerRight">
      ...
      <div class="grid grid-cols-3 items-center justify-center text-center w-72">
        <div class="col-span-1 w-20 arrow arrow--left" @click="prevColor('background')">
          <span>Prev</span>
        </div>
        <span class="col-span-1 w-60 cursor-pointer hover:text-red-500 " @click="removeTrait('background')"
              @mouseenter="isHovered.background = true" @mouseleave="isHovered.background = false">
          {{ isHovered.background ? 'Remove' : 'Background' }}
        </span>
        <div class="arrow arrow--right col-span-1 w-20" @click="nextColor('background')">
          <span>Next</span>
        </div>
      </div>
