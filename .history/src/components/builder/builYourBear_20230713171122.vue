      ...
      <div class="mt-3 ">
        ...
        <div id="speciesBuilderTab" class="hidden" role="tabpanel" aria-labelledby="speciesBuilderSelector">
          <div class="content center justify-center">
            <div class="carousel2">
              <img src="../../assets/images/traits/species/01.png" class="product-image" data-trait="background"
                data-src="01.png" alt="">
              <img src="../../assets/images/traits/species/02.png" class="product-image" data-trait="background"
                data-src="02.png" alt="">
              <img src="../../assets/images/traits/species/03.png" class="product-image" data-trait="background"
                data-src="03.png" alt="">
              <img src="../../assets/images/traits/species/04.png" class="product-image" data-trait="background"
                data-src="04.png" alt="">
              <img src="../../assets/images/traits/species/05.png" class="product-image" data-trait="background"
                data-src="05.png" alt="">
            </div>
          </div>
        </div>
