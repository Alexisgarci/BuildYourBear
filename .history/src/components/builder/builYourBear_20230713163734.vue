    ...
    <div class="">
      ...
      <div class="flex items center justify-center">
        <div class=" w-80 h-80" id="bearBuilder">
          <div  class="absolute left-0 w-full h-full" id="backgroundBuilderCanvas" data-trait="background"></div>  
          <div style="z-index:2;" class="absolute left-0  w-full h-full" id="speciesBuilderCanvas"></div>  
          <div class=" absolute left-0 w-full h-full" id="faceBuilderCanvas"></div>  
          <div class="absolute left-0  w-full h-full" id="clothesBuilderCanvas"></div>  
          <div class=" absolute left-0 w-full h-full" id="facialhairBuilderCanvas"></div>  
          <div class=" absolute left-0 w-full h-full" id="facewearBuilderCanvas" ></div>  
          <div class=" absolute left-0 w-full h-full" id="headwearBuilderCanvas" ></div>  
          <div class=" absolute left-0 w-full h-full" id="cigarpipeBuilderCanvas"></div>  
        </div>
      </div>
      <div class="flex items center justify-center">
        <div>
