<template>
  <div class="flex items-center justify-center">
    ...
    <div class="w-80 h-80 relative" id="bearBuilder">
      ...
      <div class="absolute left-0 w-full h-full z-80" id="cigarBuilderCanvas"></div>
    </div>
    ...
    <div class="traitsPickerRight">
      ...
      <div class="grid grid-cols-3 items-center justify-center text-center">
        <div class="arrow arrow--left" @click="prevColor('cigar')">
          <span>Prev</span>
        </div>
        <span class="">Cigar/Pipe</span>
        <div class="arrow arrow--right" @click="nextColor('cigar')">
          <span>Next</span>
        </div>
      </div>
    </div>
