  ...
  <div class="flex items-center justify-center">
    ...
    <div class="traitsPickerRight">
      <div class="grid grid-cols-3 items-center justify-center text-center">
        ...
        <span class="pointer" @click="removeTrait('background')">Background</span>
      ...
      <div class="grid grid-cols-3 items-center justify-center text-center">
        ...
        <span class="" @click="removeTrait('species')">Species</span>
      ...
      <div class="grid grid-cols-3 items-center justify-center text-center">
        ...
        <span class="" @click="removeTrait('face')" >Face</span>
      ...
      <div class="grid grid-cols-3 items-center justify-center text-center">
        ...
        <span class="" @click="removeTrait('facialhair')" >Facial Hair</span>
    ...
    <div class="traitsPickerRight">
      <div class="grid grid-cols-3 items-center justify-center text-center">
        ...
        <span class="" @click="removeTrait('clothes')">Clothes</span>
      ...
      <div class="grid grid-cols-3 items-center justify-center text-center">
        ...
        <span class="" @click="removeTrait('headwear')">Headwear</span>
      ...
      <div class="grid grid-cols-3 items-center justify-center text-center">
        ...
        <span class="" @click="removeTrait('facewear')">Facewear</span>
      ...
      <div class="grid grid-cols-3 items-center justify-center text-center">
        ...
        <span class="" @click="removeTrait('cigarpipe')">Cigar/Pipe</span>
