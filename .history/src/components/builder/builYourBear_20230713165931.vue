  ...
  <div id="backgroundsBuilderTab" role="tabpanel" aria-labelledby="backgroundsBuilderSelector">
    <div class="content center justify-center">
      <div class="carousel center justify-center">
              <img src="../../assets/images/traits/species/01.png" class="product-image" data-trait="background" data-src="01.png" alt="">
              <img src="../../assets/images/traits/species/02.png" class="product-image" data-trait="background" data-src="02.png" alt="">
              <img src="../../assets/images/traits/species/03.png" class="product-image" data-trait="background" data-src="03.png" alt="">
              <img src="../../assets/images/traits/species/04.png" class="product-image" data-trait="background" data-src="04.png" alt="">
              <img src="../../assets/images/traits/species/05.png" class="product-image" data-trait="background" data-src="05.png" alt="">
            </div>
    </div>
  </div>
  ...
  methods: {
    setListeners: function() {
      $('.carousel').on('afterChange', (event, slick, currentSlide) => {
        ...
        $('#backgroundBuilderCanvas').css('background-image', 'url(src/assets/images/traits/species/' + dataSrc + ')');
