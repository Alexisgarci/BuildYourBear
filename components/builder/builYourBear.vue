<template>
    <div>
      <div class="builderContainer">
        ...
        <div>
          <div @click="downloadCanvas" > <img id="downloadBTN" src="../../assets/images/downloadbt.png" alt="Save your Bear fam!"> </div>
        </div>
      </div>
...
#speciesSelector{
    background-image: url(../../assets/images/traits/species/02.png);
    background-size: 60%;
...
#faceSelector{
  background-image: url(../../assets/images/traits/face/01.png);
    background-position: center;
    background-position-y: -7px;
    background-position-x: 3px;
}
#clothesSelector{
  background-image: url(../../assets/images/traits/clothes/02.png);
  background-position: center;
    background-position-y: -27px;
    background-position-x: 2px;
}
#facialhairSelector{
  background-image: url(../../assets/images/traits/facialhair/05.png);
  background-position: center;
    background-position-y: -9px;
    background-position-x: 4px;
}
#facewearSelector{
  background-image: url(../../assets/images/traits/facewear/01.png);
  background-position: center;
    background-position-y: 0px;
    background-position-x: 3px;
}
#headwearSelector{
  background-image: url(../../assets/images/traits/headwear/20.png);
  background-position: center;
    background-position-y: 14px;
    background-position-x: 4px;
}
#cigarpipeSelector{
  background-image: url(../../assets/images/traits/cigarpipe/02.png);
  background-position: center;
